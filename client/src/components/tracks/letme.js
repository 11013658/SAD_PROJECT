...
import letme from '../audios/let-me-love-you.mp3';
import letmeimg from '../images/letme.jpg';
import { Button, Container } from '@material-ui/core';


class Letme extends React.Component {
	constructor(props) {
		super(props);
	...
	render() {
        ...
        <div className="row">
            ...
            <h3>DJ Snake & Justin Bieber - Let Me Love You</h3>
                <img src={letmeimg} height="200" width="200" />
                <span>          </span>
