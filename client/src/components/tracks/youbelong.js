...
import you from '../audios/you-belong-with-me.mp3';
import youimg from '../images/you.png';
import { Button, Container } from '@material-ui/core';


class Youbelong extends React.Component {
	constructor(props) {
		super(props);
	...
	render() {
        ...
        <div className="row">
            ...
            <h3>Taylor Swift - You Belong With Me</h3>
                <img src={youimg} height="200" width="200" />
                <span>          </span>
